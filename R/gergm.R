...
#' @param using_correlation_network Experimental feature to estimate GERGM's for correlation networks. Defaults to FALSE. It is highly inadvisable to use this feature until it is better understood.
